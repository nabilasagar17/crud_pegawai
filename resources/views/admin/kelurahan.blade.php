            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{url('admin/input_kelurahan')}}" method="post" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="modal fade" id="edit_data">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{url('admin/edit_kelurahan')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <a href="{{url('admin/print_kelurahan')}}" class="btn btn-info btn-block"><i
                                            class="fa fa-print"></i>
                                        Print</a>
                                </div>
                                @else
                                <div class="col-lg-2">
                                    <a href="{{url('admin/print_kelurahan').'?search='.(Request::input('search'))}}"
