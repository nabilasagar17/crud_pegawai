            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{url('admin/input_kecamatan')}}" method="post" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="modal fade" id="edit_data">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{url('admin/edit_kecamatan')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
            ...
            <div class="modal fade" id="hapus_data">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="{{url('admin/hapus_kecamatan')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <a href="{{url('admin/print_kecamatan')}}" class="btn btn-info btn-block"><i
                                            class="fa fa-print"></i>
                                        Print</a>
                                </div>
                                @else
                                <div class="col-lg-2">
                                    <a href="{{url('admin/print_kecamatan').'?search='.(Request::input('search'))}}"
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                onClick="edit_data('{{ $datas->id}}','{{ $datas->kode}}','{{ $datas->nama}}')"
...
<script>
function edit_data(id, kode, nama) {
